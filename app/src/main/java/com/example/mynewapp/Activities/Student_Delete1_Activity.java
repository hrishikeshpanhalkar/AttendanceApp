...
public class Student_Delete1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student__delete1);
        reff= FirebaseDatabase.getInstance().getReference().child("Member");
        Nextbtn=(Button)findViewById(R.id.student_delete_btn);
        Course=(AutoCompleteTextView) findViewById(R.id.student_delete_course);
        Semester=(AutoCompleteTextView) findViewById(R.id.student_delete_semester);
                    ...
                    for(int i=1;i<=noOf;i++) {
                        reff.child(String.valueOf(i)).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                adapter2 = new ArrayAdapter<String>(Student_Delete1_Activity.this,
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ValueEventListener valueEventListener = new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        ada = new ArrayAdapter<String>(Student_Delete1_Activity.this,
        ...
        Nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Course.getText().equals("")){
                    Toast.makeText(Student_Delete1_Activity.this, "Please Select Course!", Toast.LENGTH_SHORT).show();
                }else if(Semester.getText().equals("")){
                    Toast.makeText(Student_Delete1_Activity.this, "Please Select Semister!", Toast.LENGTH_SHORT).show();
                }else {
                    Intent intent = new Intent(Student_Delete1_Activity.this, Student_Delete_Activity.class);
